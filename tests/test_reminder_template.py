...
import config
config.reload_web_flags_from_disk()
...
Вопросы на sd@asg.ru."""
        ...
        self.assertIn("<strong style=\"font-weight: 700; color: #0f172a;\">Пожалуйста, проведите инвентаризацию закрепленной за вами рабочей техники.</strong>", html)
        self.assertIn("<strong style=\"font-weight: 700; color: #0f172a;\">Для проведения инвентаризации перейдите по ссылке:</strong>", html)
    ...
    def test_build_reminder_message(self):
        ...
        self.assertIn("Пожалуйста, проведите инвентаризацию закрепленной за вами рабочей техники.</strong>", html_body)
        self.assertIn("Для проведения инвентаризации перейдите по ссылке:</strong>", html_body)
    ...
    def test_send_plain_text_email_with_html(self, mock_ssl, mock_smtp):
        ...
        self.assertIn("MIME-Version: 1.0", sent_raw)
