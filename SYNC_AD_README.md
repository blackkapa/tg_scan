...
- **Создание:** если сотрудник из AD не найден в A-Tracker — создаётся новый (только если почта @asg.ru). Нужен сервис 7 в A-Tracker (см. ATRACKER_SERVICE_7_EmployeeAdd.cs).
